...
online version: https://docs.microsoft.com/powershell/module/az.springcloud/get-azspringcloudgatewayrouteconfig
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzSpringCloudGatewayRouteConfig -InputObject <ISpringCloudIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
