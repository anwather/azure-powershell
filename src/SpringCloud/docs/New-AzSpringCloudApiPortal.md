...
online version: https://docs.microsoft.com/powershell/module/az.springcloud/new-azspringcloudapiportal
schema: 2.0.0
---

# New-AzSpringCloudApiPortal
...
```
New-AzSpringCloudApiPortal -Name <String> -ResourceGroupName <String> -ServiceName <String>
