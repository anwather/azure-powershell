...
online version: https://docs.microsoft.com/powershell/module/az.springcloud/new-azspringclouddeploymentheapdump
schema: 2.0.0
---
...
```
New-AzSpringCloudDeploymentHeapDump -AppName <String> -DeploymentName <String> -ResourceGroupName <String>
...
### GenerateViaIdentity
```
New-AzSpringCloudDeploymentHeapDump -InputObject <ISpringCloudIdentity>
...
```
New-AzSpringCloudDeploymentHeapDump -InputObject <ISpringCloudIdentity> [-AppInstance <String>]
