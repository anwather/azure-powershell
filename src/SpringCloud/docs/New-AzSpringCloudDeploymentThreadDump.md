...
online version: https://docs.microsoft.com/powershell/module/az.springcloud/new-azspringclouddeploymentthreaddump
schema: 2.0.0
---
...
```
New-AzSpringCloudDeploymentThreadDump -AppName <String> -DeploymentName <String> -ResourceGroupName <String>
...
### GenerateViaIdentity
```
New-AzSpringCloudDeploymentThreadDump -InputObject <ISpringCloudIdentity>
...
```
New-AzSpringCloudDeploymentThreadDump -InputObject <ISpringCloudIdentity> [-AppInstance <String>]
