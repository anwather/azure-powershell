...
online version: https://docs.microsoft.com/powershell/module/az.springcloud/remove-azspringcloudgatewayrouteconfig
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzSpringCloudGatewayRouteConfig -InputObject <ISpringCloudIdentity> [-DefaultProfile <PSObject>]
 [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
