...
online version: https://docs.microsoft.com/powershell/module/az.springcloud/set-azspringcloudapiportal
schema: 2.0.0
---

# Set-AzSpringCloudApiPortal
...
```
Set-AzSpringCloudApiPortal -Name <String> -ResourceGroupName <String> -ServiceName <String>
