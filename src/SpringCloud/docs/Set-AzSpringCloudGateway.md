...
online version: https://docs.microsoft.com/powershell/module/az.springcloud/set-azspringcloudgateway
schema: 2.0.0
---

# Set-AzSpringCloudGateway
...
```
Set-AzSpringCloudGateway -Name <String> -ResourceGroupName <String> -ServiceName <String>
...
### Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.Api202201Preview.IGatewayResource
