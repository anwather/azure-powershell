...
online version: https://docs.microsoft.com/powershell/module/az.springcloud/start-azspringclouddeploymentjfr
schema: 2.0.0
---

# Start-AzSpringCloudDeploymentJfr
...
```
Start-AzSpringCloudDeploymentJfr -AppName <String> -DeploymentName <String> -ResourceGroupName <String>
...
### StartViaIdentity
```
Start-AzSpringCloudDeploymentJfr -InputObject <ISpringCloudIdentity>
...
```
Start-AzSpringCloudDeploymentJfr -InputObject <ISpringCloudIdentity> [-AppInstance <String>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.Api202201Preview.IDiagnosticParameters
...
### Microsoft.Azure.PowerShell.Cmdlets.SpringCloud.Models.Api202201Preview.IDiagnosticParameters
