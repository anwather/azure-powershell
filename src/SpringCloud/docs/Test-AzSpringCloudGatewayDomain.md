...
online version: https://docs.microsoft.com/powershell/module/az.springcloud/test-azspringcloudgatewaydomain
schema: 2.0.0
---

# Test-AzSpringCloudGatewayDomain
...
```
Test-AzSpringCloudGatewayDomain -GatewayName <String> -ResourceGroupName <String> -ServiceName <String>
...
### ValidateViaIdentity
```
Test-AzSpringCloudGatewayDomain -InputObject <ISpringCloudIdentity>
...
```
Test-AzSpringCloudGatewayDomain -InputObject <ISpringCloudIdentity> -Name <String>
