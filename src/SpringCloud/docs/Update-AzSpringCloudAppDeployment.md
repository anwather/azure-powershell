...
Update-AzSpringCloudAppDeployment -AppName <String> -Name <String> -ResourceGroupName <String>
 ...
 [-JvmOption <String>] [-MemoryInGb <Int32>] [-SourceArtifactSelector <String>] [-SourceRelativePath <String>]
...
Update-AzSpringCloudAppDeployment -InputObject <ISpringCloudIdentity> [-Cpu <Int32>]
 ...
 [-SourceArtifactSelector <String>] [-SourceRelativePath <String>] [-SourceType <String>]
